...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PredictionEnterpriseApi.Historical();
  });
  ...
  describe('Historical', function() {
    it('should create an instance of Historical', function() {
      // uncomment below and update the code to test Historical
      //var instane = new PredictionEnterpriseApi.Historical();
      //expect(instance).to.be.a(PredictionEnterpriseApi.Historical);
    });
