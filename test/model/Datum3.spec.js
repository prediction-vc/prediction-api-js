...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PredictionEnterpriseApi.Datum3();
  });
  ...
  describe('Datum3', function() {
    it('should create an instance of Datum3', function() {
      // uncomment below and update the code to test Datum3
      //var instane = new PredictionEnterpriseApi.Datum3();
      //expect(instance).to.be.a(PredictionEnterpriseApi.Datum3);
    });
