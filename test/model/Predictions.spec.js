...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PredictionEnterpriseApi.Predictions();
  });
  ...
  describe('Predictions', function() {
    it('should create an instance of Predictions', function() {
      ...
      //var instane = new PredictionEnterpriseApi.Predictions();
      //expect(instance).to.be.a(PredictionEnterpriseApi.Predictions);
    });
