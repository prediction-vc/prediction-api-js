...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PredictionEnterpriseApi.PredictionsAccuracy();
  });
  ...
  describe('PredictionsAccuracy', function() {
    it('should create an instance of PredictionsAccuracy', function() {
      // uncomment below and update the code to test PredictionsAccuracy
      //var instane = new PredictionEnterpriseApi.PredictionsAccuracy();
      //expect(instance).to.be.a(PredictionEnterpriseApi.PredictionsAccuracy);
    });
