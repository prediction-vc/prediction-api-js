...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PredictionEnterpriseApi.Ohlc();
  });
  ...
  describe('Ohlc', function() {
    it('should create an instance of Ohlc', function() {
      // uncomment below and update the code to test Ohlc
      //var instane = new PredictionEnterpriseApi.Ohlc();
      //expect(instance).to.be.a(PredictionEnterpriseApi.Ohlc);
    });
