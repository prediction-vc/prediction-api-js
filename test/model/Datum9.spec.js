...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PredictionEnterpriseApi.Datum9();
  });
  ...
  describe('Datum9', function() {
    it('should create an instance of Datum9', function() {
      // uncomment below and update the code to test Datum9
      //var instane = new PredictionEnterpriseApi.Datum9();
      //expect(instance).to.be.a(PredictionEnterpriseApi.Datum9);
    });
