...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PredictionEnterpriseApi.OHLCApi();
  });
  ...
  describe('OHLCApi', function() {
    describe('ohlcGet', function() {
      it('should call ohlcGet successfully', function(done) {
        //uncomment below and update the code to test ohlcGet
        //instance.ohlcGet(function(error) {
