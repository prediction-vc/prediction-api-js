...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PredictionEnterpriseApi.HistoricalApi();
  });
  ...
  describe('HistoricalApi', function() {
    describe('historicalGet', function() {
      it('should call historicalGet successfully', function(done) {
        //uncomment below and update the code to test historicalGet
        //instance.historicalGet(function(error) {
