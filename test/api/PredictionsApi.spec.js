...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PredictionEnterpriseApi.PredictionsApi();
  });
  ...
  describe('PredictionsApi', function() {
    describe('predictionsAccuracyGet', function() {
      it('should call predictionsAccuracyGet successfully', function(done) {
        //uncomment below and update the code to test predictionsAccuracyGet
        //instance.predictionsAccuracyGet(function(error) {
    ...
    describe('predictionsTokensGet', function() {
      it('should call predictionsTokensGet successfully', function(done) {
        //uncomment below and update the code to test predictionsTokensGet
        //instance.predictionsTokensGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
