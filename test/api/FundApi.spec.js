...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PredictionEnterpriseApi.FundApi();
  });
  ...
  describe('FundApi', function() {
    describe('fundTradesGet', function() {
      it('should call fundTradesGet successfully', function(done) {
        //uncomment below and update the code to test fundTradesGet
        //instance.fundTradesGet(function(error) {
    ...
    describe('fundTradesTokensGet', function() {
      it('should call fundTradesTokensGet successfully', function(done) {
        //uncomment below and update the code to test fundTradesTokensGet
        //instance.fundTradesTokensGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
